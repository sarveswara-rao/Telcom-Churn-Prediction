...
if __name__ == "__main__":
	...
	for i in range(X.shape[1]):
		...
		accuracy = cross_val_score(KNeighborsClassifier(), X_new, y, scoring = 'accuracy',
		 						cv = StratifiedKFold(5))
		precision = cross_val_score(KNeighborsClassifier(), X_new, y,
						 scoring = 'precision', cv = StratifiedKFold(5))
		f1 = cross_val_score(KNeighborsClassifier(), X_new, y, 
						scoring = 'f1', cv = StratifiedKFold(5))
		recall = cross_val_score(KNeighborsClassifier(), X_new, y,
						scoring = 'recall', cv = StratifiedKFold(5))
		auc = cross_val_score(KNeighborsClassifier(), X_new, y,
